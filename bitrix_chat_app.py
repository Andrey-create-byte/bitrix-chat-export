...
def download_files(messages, folder_name): os.makedirs(folder_name, exist_ok=True) file_count = sum(len(message.get('files', [])) for message in messages) progress_bar = st.progress(0) downloaded = 0
